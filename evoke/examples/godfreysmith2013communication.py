...
class GodfreySmith2013_1(Scatter):
    ...
    def calculate_results_per_c(self, games_per_c):
        ...
        while True:
            ...
            c = self.calculate_C(state_chances, sender_payoff_matrix, receiver_payoff_matrix)
    ...
    def calculate_C(self,state_chances,sender_payoff_matrix,receiver_payoff_matrix):
        """
